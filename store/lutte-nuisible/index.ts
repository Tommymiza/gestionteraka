...
const lutteNuisibleStore = create<LutteNuisibleStore>((set) => ({
  ...
  updateLutteNuisible: async ({ id, lutteNuisible }) => {
    try {
      ...
      const response = await axios.patch(
        `/configuration/lutte-nuisible/${id}`,
        lutteNuisible
      );
  ...
  getLutteNuisible: async ({ id, args = {} }) => {
    try {
      ...
      const response = await axios.get(`/configuration/lutte-nuisible/${id}`, {
        params,
      });
  ...
  getLutteNuisibles: async (args = {}) => {
    try {
      ...
      const response = await axios.get(`/configuration/lutte-nuisible`, {
        params,
      });
